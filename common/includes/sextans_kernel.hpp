#ifndef SEXTANS_KERNEL_HPP
#define SEXTANS_KERNEL_HPP
...
#ifndef SEXTANS_WINDOW_SIZE
#define SEXTANS_WINDOW_SIZE 4096
#endif
#ifndef SEXTANS_DEP_DIST_LOAD_STORE
#define SEXTANS_DEP_DIST_LOAD_STORE 10
#endif
#ifndef SEXTANS_B_PARTITION_FACTOR
#define SEXTANS_B_PARTITION_FACTOR 4
#endif
#ifndef SEXTANS_URAM_DEPTH
#define SEXTANS_URAM_DEPTH 12288
#endif

const int WINDOW_SIZE = SEXTANS_WINDOW_SIZE;
const int DEP_DIST_LOAD_STORE = SEXTANS_DEP_DIST_LOAD_STORE;
const int B_PARTITION_FACTOR = SEXTANS_B_PARTITION_FACTOR;
const int URAM_DEPTH = SEXTANS_URAM_DEPTH;
...
inline float uint32_to_float(ap_uint<32> u) {
#pragma HLS inline
//#pragma HLS pipeline II=1
...
inline ap_uint<32> float_to_uint32(float u) {
#pragma HLS inline
//#pragma HLS pipeline II=1
...
inline void read_edge_list_ptr(
